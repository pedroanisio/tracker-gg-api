"""
Shared Pydantic models for Tracker.gg Valorant API responses.
These models are used across both ingestion and API exposure.
"""
...
class LoadoutType(str, Enum):
    ...
    RIFLE = "rifle"
    HEAVY = "heavy"
    FULL = "full"  # Added from real data
